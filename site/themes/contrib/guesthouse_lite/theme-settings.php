...
function guesthouse_lite_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'guesthouse_lite/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'guesthouse_lite'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'guesthouse_lite'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_text'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_text','guesthouse_lite'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (guesthouse_lite/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'guesthouse_lite'),
    '#options' => array(
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['color_scheme'] = array(
    ...
    '#default_value' => theme_get_setting('color_scheme', 'guesthouse_lite'),
    '#options' => array(
    'blue' => t('Blue'),
    'khaki' => t('Khaki Grey'),
    'gold' => t('Gold Loulou (Default)'),
    'gray' => t('Grey Blue'),
    'green' => t('Green'),
    'lime' => t('Lime Orange'),
    'night-blue' => t('Night-Blue Grey'),
    'orange' => t('Orange'),
    'orange-blue' => t('Orange Blue'),
    'pink' => t('Pink'),
    'purple' => t('Purple'),
    'red' => t('Red'),
    ),
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['page_container_border'] = array(
    ...
    '#default_value' => theme_get_setting('page_container_border', 'guesthouse_lite'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['premium_description'] = array(
   '#type' => 'item',
   '#markup' =>
   '<div class="theme-settings-title theme-settings-title--premium-link"><a href="https://morethanthemes.com/themes/guesthouseplus?utm_source=guesthouse-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">'.t("Available in the Premium version of this theme").'</a></div>',
  );
